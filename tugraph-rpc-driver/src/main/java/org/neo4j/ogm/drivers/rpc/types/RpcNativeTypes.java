 ...
 */
package org.neo4j.ogm.drivers.rpc.types;
...
import org.neo4j.ogm.drivers.rpc.types.adapter.RpcValueToPointAdapter;
import org.neo4j.ogm.drivers.rpc.types.adapter.PointToBoltValueAdapter;
 ...
 */
class RpcNativeTypes implements TypeSystem {
    ...
    private static void addSpatialFeatures(Map<Class<?>, Function> nativeToMappedAdapter,
        ...
        nativeToMappedAdapter.put(Point.class, new RpcValueToPointAdapter());
